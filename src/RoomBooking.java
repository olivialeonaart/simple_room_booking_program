    ...
    public static void main(String[] args) {
        ...
        if (choice_start == 1) {
            ...
            if (choice_occupancy == 1) {
                occupancychoice = occupancytype1;
            } else if (choice_occupancy == 2) {
                occupancychoice = occupancytype2;
            } else if (choice_occupancy == 3) {
                occupancychoice = occupancytype3;
            } else if (choice_occupancy == 4) {
                System.exit(0);
            } else {
                System.out.print(linebreak + "Please input choices numbered 1 through 4 or manually exit the program: ");
            }
        ...
        if (choice_bedconfig == 1) {
            bedconfigchoice = bedconfig_full;
        }
        else if (choice_bedconfig == 2) {
            bedconfigchoice = bedconfig_queen;
        }
        else if (choice_bedconfig == 3) {
            bedconfigchoice = bedconfig_king;
        }
        else if (choice_bedconfig == 4) {
            System.exit(0);
        ...
        //menu 4
        System.out.println(linebreak + "Please select your preferred room layout: " + linebreak);
        ...
        System.out.print("Choice: ");
        int choice_roomlayout = scanner.nextInt();

        if (choice_roomlayout == 1) {
            layoutchoice = layout_standard;
        }
        else if (choice_roomlayout == 2) {
            layoutchoice = layout_deluxe;
        }
        else if (choice_roomlayout == 3) {
            layoutchoice = layout_suite;
        }
        else if (choice_roomlayout == 4) {
            System.exit(0);
        }
        else {
            System.out.print(linebreak + "Please input choices numbered 1 through 4 or manually exit the program: ");
        ...
        //menu 5 y/n
        System.out.println(linebreak + "Would you like to hear about our offered accessibility features? " + linebreak);
        ...
        System.out.print("Choice: ");
        int choice_specialfeaturesmenu = scanner.nextInt();

        if (choice_specialfeaturesmenu == 1) {
            //next menu
        }
        else if (choice_specialfeaturesmenu == 2) {
            //results display
            System.out.println(linebreak + "Thank you for choosing our room booking service!");
            System.out.println(linebreak + "Here are your selected preferences: " + linebreak);

            System.out.println("Occupancy Type: " + occupancychoice);
            System.out.println("Bed Configuration: " + bedconfigchoice);
            System.out.println("Room Layout: " + layoutchoice);
            System.out.println("Accessibility Features: None" + linebreak);

            System.out.println("The booking system will now close, press any key to EXIT PROGRAM");
            int end_program = scanner.nextInt();
                System.exit(0);
            }
        else if (choice_specialfeaturesmenu == 3) {
            System.exit(0);
        }
        }
